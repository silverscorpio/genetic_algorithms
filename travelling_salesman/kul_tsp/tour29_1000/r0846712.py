...
while i < 1000:
    ...
    tsp = r0846712()
    Mean_Obj, Best_Obj, Best_Sol = tsp.optimize("./tour29.csv")
    meanObjectiveRecord.append(Mean_Obj)
    bestObjectiveRecord.append(Best_Obj)
    bestSolutionRecord.append(Best_Sol)
    i+=1