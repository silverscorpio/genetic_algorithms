...
def routeMutateRate(singleRoute):
    return max(0.25, (0.3 + (0.05 * r.random())))
...
### 2-OPT LOCAL SEARCH OPERATOR/OPTIMIZATION
...
sizeOfPopulation = 250
children = 250 - eliteRoutes
k = 3
alpha = 0.5
beta = 1
iters = 50
...
print("\n-------------------------------------------------------------\n")
print(f"Running 2-opt Local Search for {optiRunTime * numberOfTwoOpt} seconds...")
print("\n-------------------------------------------------------------\n")
